    ...
    <div class="header bg-gradient-info pb-6">
      <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Gerenciar administradores</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="row">          
            <div class="col">
              <h1 class="display-2 text-white">Gerenciar ADMs</h1>              
              <p class="text-white mt-0 mb-5">Aqui estão listados todos os resultados referentes aos administradores cadastrados no sistema iPet.</p>
            </div>            
          </div>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Filtrando por Administradores</h3>
                </div>
            ...
            <div class="card-body">                    
                <?php
                  ...
                  $sql_num_users = "SELECT * FROM user WHERE ranking = 3";
                  ...
                  $sql_user = "SELECT * FROM user WHERE ranking = 3 ORDER BY name ASC LIMIT $init, $num_page_itens";
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          if($array_user['status'] == 0){
                            echo "<a class='dropdown-item' href='" . BASE . "_site/_adm/delete/enable_adm.php?id=" . $filter_user . "'>Ativar</a>";
                          }else{
                            echo "<a class='dropdown-item' href='" . BASE . "_site/_adm/delete/disable_adm.php?id=" . $filter_user ."'>Desativar</a>";                            
                          }                          
                                                    
                          if($array_user['ranking'] == 3){
              ...
              <nav aria-label="...">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="edit_users.php?page=<?php if($page==1){ echo 1;}else{echo $page-1;};?>" tabindex="-1">
                      ...
                      ?>
                      <li class="page-item <?= $current; ?>"><a class="page-link" href="edit_users.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                      <?php }?>
                      <li class="page-item">
                        <a class="page-link" href="edit_users.php?page=<?php if($page<$num_pages){ echo $page+1;}else{echo $page;};?>">
