    ...
    <div class="header bg-gradient-info pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <div class="row">          
            <div class="col">
              <h1 class="display-2 text-white">Gerenciar usuários</h1>              
              <p class="text-white mt-0 mb-5">Aqui estão listados todos os resultados referentes aos usuários cadastrados no sistema iPet.</p>
            </div>            
          </div>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Filtrando por Usuários</h3>
                </div>
            ...
            <div class="card-body">                    
                <?php
                  ...
                  $sql_num_users = "SELECT * FROM user WHERE ranking = 1";
                  ...
                  $sql_user = "SELECT * FROM user WHERE ranking = 1 ORDER BY name ASC LIMIT $init, $num_page_itens";
