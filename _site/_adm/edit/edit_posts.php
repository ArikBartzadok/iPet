    ...
    <div class="header bg-gradient-info pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <div class="row">          
            <div class="col">
              <h1 class="display-2 text-white">Gerenciar postagens</h1>              
              <p class="text-white mt-0 mb-5">Aqui estão listados todos os resultados referentes as postagens cadastradas no sistema iPet.</p>
            </div>            
          </div>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Filtrando por Postagens</h3>
                </div>
            ...
            <div class="card-body">                    
                <?php
                  ...
                  $sql_num_posts = "SELECT * FROM post";
                  ...
                  $sql_post = "SELECT * FROM post ORDER BY id_post DESC LIMIT $init, $num_page_itens";
                ...
                <div>                                    
                  <table class="table align-items-center">
                    ...
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          <div class="avatar-group">
                            <a href="#" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="<?= $array_post['title']; ?>">
                              <img alt="Image placeholder" src="<?= PUBLICO . 'img/posts/' . $array_post['image']; ?>">
                            </a>                      
                          </div>    
                      ...
                      <td>
                        <a class="btn btn-neutral btn-icon" href="https://api.whatsapp.com/send?phone=55<?= $array_post['telephone']; ?>&amp;text=iPet%20-%20Ol%C3%A1,%20eu%20gostaria%20de%20contatar%20vocês" class="btn btn-neutral btn-icon" target="_blank">
                      ...
                      <td>
                        <span class="badge badge-dot mr-4">                        
                          <i class="<?php
                            ...
                            ?>"></i>  
                          <span class="status"><?= $array_post['city_author'] . ", " . $array_post['uf'];?></span>                        
                        </span>
                      </td>
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <?php                                                    
                            echo "<a class='dropdown-item' href='" . BASE . "_site/_adm/delete/adm_remove_post.php?id=" . $array_post['id_post'] . "'>Deletar</a>";                        
                          ?>                            
                          </div>
                        </div>
                      </td>
