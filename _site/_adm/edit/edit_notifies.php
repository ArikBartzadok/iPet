    ...
    <div class="header bg-gradient-info pb-6">
      <div class="container-fluid">
        <div class="header-body">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Gerenciar notificações</li>
                </ol>
              </nav>
            </div>
          ...
          <div class="row">          
            <div class="col">
              <h1 class="display-2 text-white">Gerenciar notificações</h1>              
              <p class="text-white mt-0 mb-5">Aqui estão listados todos os resultados referentes as notificações cadastradas no sistema iPet.</p>
            </div>            
          </div>
        </div>
      </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Filtrando por Notificações</h3>
                </div>
            ...
            <div class="card-body">                    
                <?php
                  ...
                  $sql_num_posts = "SELECT * FROM notify";
                  $res_num_posts = mysqli_query($con, $sql_num_posts);

                  //Parâmetro inicial do filtro SQL LIMIT
                  $init = ($num_page_itens*$page)-$num_page_itens;
                
                  //Executando query para seleção de todos os posts
                  $sql_post = "SELECT * FROM notify ORDER BY id_not DESC LIMIT $init, $num_page_itens";
                  ...
                  $quanty_posts = mysqli_num_rows($res_num_posts);   
                ...
                <div>                                    
                  <table class="table align-items-center">
                    <thead class="thead-light">
                      <tr>                        
                        <th scope="col" class="sort" data-sort="name">Usuário</th>                                                
                        <th scope="col" class="sort" data-sort="budget">Contato</th>
                        <th scope="col" class="sort" data-sort="status">Descrição</th>                        
                        <th scope="col" class="sort" data-sort="completion">Origem</th>
                      ...
                      <th scope="row">
                        <div class="media align-items-center">
                          <div class="avatar-group">
                            <a href="#" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="<?= $array_post['name_user']; ?>">
                              <img alt="Image placeholder" src="<?= PUBLICO . 'img/users/' . $array_post['image_user']; ?>">
                            </a>                      
                          </div>    
                          <div class="media-body">
                            ...
                            if($array_post['type'] == 3){
                              ...
                              echo "text-warning";
                            }elseif($array_post['type'] == 4){
                              echo "text-success";
                            }else{
                              echo "";
                            }
                            ?>"><?= $array_post['title']; ?></span>
                          </div>
                        </div>
                      </th>                      
                      <td>
                        <a class="btn btn-neutral btn-icon" href="https://api.whatsapp.com/send?phone=55<?= $array_post['telephone_user']; ?>&amp;text=iPet%20-%20Ol%C3%A1,%20eu%20gostaria%20de%20contatar%20vocês" class="btn btn-neutral btn-icon" target="_blank">
                  ...
                  ?>                                                             
                      ...
                      <td>
                        <span class="badge badge-dot mr-4">                        
                          <i class="<?php
                            if($array_post['origin'] == 0){
                              echo "bg-success";
                            }elseif($array_post['type'] == 1){
                              echo "bg-danger";
                            }else{
                              echo "bg-info";
                            }
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <?php                                                    
                            echo "<a class='dropdown-item' href='" . BASE . "_site/_adm/delete/adm_delete_notify.php?id=" . $array_post['id_not'] . "'>Deletar</a>";                        
                          ?>                            
                          </div>
                        </div>
                      </td>
              ...
              <nav aria-label="...">
                    <ul class="pagination">
                      <li class="page-item">
                        <a class="page-link" href="edit_posts.php?page=<?php if($page==1){ echo 1;}else{echo $page-1;};?>" tabindex="-1">
                      ...
                      ?>
                      <li class="page-item <?= $current; ?>"><a class="page-link" href="edit_posts.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                      <?php }?>
                      <li class="page-item">
                        <a class="page-link" href="edit_posts.php?page=<?php if($page<$num_pages){ echo $page+1;}else{echo $page;};?>">
