    <nav class="navbar navbar-top navbar-expand navbar-dark bg-gradient-info border-bottom">
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form method="POST" action="<?= BASE . '_site/_ong/share/share.php?filter=' . $_SESSION['filter'];?>" class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
                <div class="row shortcuts px-4">
                  <a href="<?= BASE . '_site/_ong/list/list_log.php'; ?>" class="col-4 shortcut-item">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="<?= BASE . '_site/_ong/profile.php'; ?>" class="dropdown-item">
                  <i class="ni ni-single-02"></i>
                  <span>Meu perfil</span>
                </a>
                <a href="<?= BASE . '_site/_ong/edit/edit_config.php'; ?>" class="dropdown-item">
