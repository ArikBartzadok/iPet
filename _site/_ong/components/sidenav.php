  <nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="<?= BASE . '_site/_ong/home.php';?>">
      ...
      ?>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="<?= BASE . '_site/_ong/home.php';?>">
                <i class="ni ni-tv-2 text-default"></i>
                <span class="nav-link-text">Home</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?= BASE . '_site/_ong/list/list_pets.php';?>">
                <i class="ni ni-tag text-info"></i>
                <span class="nav-link-text">Pets</span>
              </a>
            </li> 
            <li class="nav-item">
              <a class="nav-link" href="<?= BASE . '_site/_ong/list/list_ongs.php';?>">
                <i class="ni ni-badge text-primary"></i>
                <span class="nav-link-text">ONGs</span>
              </a>
            </li>            
            <li class="nav-item">
              <a class="nav-link" href="<?= BASE . '_site/_ong/list/list_users.php';?>">
            ...
            ?>
              <a class="nav-link" href="<?= BASE . '_site/_ong/list/list_favs.php';?>">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="<?= BASE . '_site/_ong/upload/upload_post.php';?>">
            ...
            ?>
              <a class="nav-link" href="<?= BASE . '_site/_ong/list/list_posts.php';?>">
